...
public class GameParameters {
	...
	public static final double NUCLEAR_POWER_PLANT_COST_FACTOR = 1.5;
	public static final double NUCLEAR_POWER_PLANT_PRODUCTION_FACTOR = 1.25;
	public static final double SOLAR_POWER_PLANT_ENERGY = -20;
	public static final double SOLAR_POWER_PLANT_PRODUCTION_FACTOR = 1.2;
	public static final double SOLAR_POWER_PLANT_COST_FACTOR = 1.4;

	// TODO: replace with real values
	public static final Ressources METAL_MINE_PRODUCTION = new Ressources(5, 0,
			0);
	public static final Ressources ANTIMONY_MINE_PRODUCTION = new Ressources(0,
			5, 0);
	public static final Ressources SOLAR_POWER_PLANT_PRODUCTION = new Ressources(
			0, 0, 3);
	public static final Ressources NUCLEAR_POWER_PLANT_PRODUCTION = new Ressources(
			0, 0, 10);
	...
	public static final Ressources LABORATORY_COSTS = new Ressources(200, 1000,
			5);
	public static final Ressources NUCLEAR_POWER_PLANT_COSTS = new Ressources(
			50, 100, 0);
	public static final Ressources SOLAR_POWER_PLANT_COSTS = new Ressources(60,
			20, 0);
	public static final Ressources SPACE_SHIPYARD_COSTS = new Ressources(100,
			70, 3);
